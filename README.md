...
Throughout the navigation of the site you can find, at the bottom of it, the flags of Spain and the U.K. representing the Spanish and English languages ​​respectively.
By clicking them you can select to navigate the site in the corresponding language.

## Error pages

The site has pages for cases in which the server returns the following errors to the user: 403, 404, 500 and 503.
They consist of a simple page where the error code is displayed and a navigation bar from which the error description can be accessed in either Spanish or English. Depending on the device from which the site is being accessed, it may be folded, following the same dynamic as the main navigation bar in the rest of the site.
